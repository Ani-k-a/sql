...
-- select category, title from products where title not like '%о%';
-- select title from products where discount_pct is null;
-- select title from products where discount_pct is null or discount_pct = 5 or discount_pct = 15;
-- select title from products where discount_pct is null or discount_pct in (5, 15);
-- select title from products where discount_pct not in (null, 5, 15);
